...
class CSV {
    ...
    public function __construct($csv_file) {
        if (file_exists($csv_file)) { //Если файл существует
           ...
           echo "file ne naiden"; //throw new Exception("Файл "$csv_file" не найден"); 
        }
    }
...
try {
    $csv = new CSV("tender.csv"); //Открываем наш csv
    /**
    ...
    foreach ($get_csv as $value) { //Проходим по строкам
        ...
        echo "Способ определения поставщика: " . $value[1] . "<br/>";
        echo "notice_orderName: " . $value[2] . "<br/>";
        echo "Место нахождения: " . $value[3] . "<br/>";
        echo "цена контракта: " . $value[4] . "<br/>";
        echo "Источник финансирования: " . $value[5] . "<br/>";
        echo "ssilka: " . $value[6] . "<br/>";
        echo "--------<br/>";*/
    //}
